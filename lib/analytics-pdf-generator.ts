...
export function generateAnalyticsExportPDF(
  ...
  doc.setFont('helvetica', 'normal');
  doc.text('Generated by Faculty Dashboard - Chennai Boys Quiz System', margin, yPosition);
...
export function generatePerformanceReportPDF(
  ...
  doc.setTextColor(150, 150, 150);
  doc.setFont('helvetica', 'normal');
  doc.text('Comprehensive Performance Report - Chennai Boys Faculty Dashboard', margin, yPosition);
